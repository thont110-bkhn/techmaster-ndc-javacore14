...
public class StreamExplaintion {
    ...
    public static void main(String[] args) {
        ...
        // c1
        System.out.println("số lượng phần tử học sinh = "+ Arrays.stream(scoreData).count());

        // c2
        System.out.printf("Tính điểm trung bình của tất cả học sinh = %1.2f \n", Arrays.stream(scoreData)
                .mapToInt(e -> e.score).average().getAsDouble());

        // c3
        System.out.println("số lượng học sinh đạt điểm A = " + Arrays.stream(scoreData)
                .filter(e -> e.score >= 90).count());
    }

    /** Các cách khởi tạo 1 stream
     * Arrays.stream()
     * Stream.of(arrays)
     * list.stream()
     * Stream.generate(() -> "techmaster").limit(3);
    ...
    public static void main1(String[] args) {
        ...
        // c1
        System.out.println("số lượng học sinh = " + Arrays.stream(scoreData).count());
         ...
         */
        System.out.println("Điểm trung bình của học sinh = " + Arrays.stream(scoreData).mapToInt(e -> e.score).average().getAsDouble());

        /// c3
        System.out.println("Số lượng học sinh đạt điểm A: " + Arrays.stream(scoreData).filter(e -> e.score >= 90).count());
        System.out.println();
